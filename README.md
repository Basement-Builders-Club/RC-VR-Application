# VR-Application
 ...
 Built off of VRTK Tutorial Scene #34.
## How to install and use
- This program is built off of the Unity Game Engine, so to properly view and edit the program first install Unity Hub.
...
- This should now let you view and edit the project (after installing the necessary editor). Currently the project is set for Oculus in the XR settings (Edit > Project Settings > XR Plug-in Management), you may have to change that depending on what VR headset you are using.
